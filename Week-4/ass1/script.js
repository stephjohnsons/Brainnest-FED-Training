...
function playRound(userSelection) {
    ...
    if (userSelection == 'rock' && comSelection == 'scissors' || 
     ...
     userMarks++;
        ...
        comSelection == 'rock' && userSelection == 'scissors' || 
        comSelection == 'paper' && userSelection == 'rock' ||
        comSelection == 'scissors' && userSelection == 'paper') {
    ...
    document.getElementById("com-res-marks").innerHTML = comMarks;
    document.getElementById("user-res-marks").innerHTML = userMarks;
    ...
    let comResult = document.getElementById("com-res-marks").innerText;
    let userResult = document.getElementById("user-res-marks").innerText;
